...
<AppLayout>
    <div class="mt-5 mb-40"> 
        <div class=" overflow-hidden  p-10">
          <h2 class="font-sans font-semibold underline decoration-wavy text-3xl text-center mb-10">Add Blog</h2>
              ...
              <div class="mt-2 mb-5">
                  <div class="flex" >
                    ...
                    <div v-if="url" class="h-40 ms-5 w-full items-center rounded-md border-dashed border-2 border-primary bg-white">
                        <img  :src="url" alt="" class=" h-full w-full bg-cover rounded-md"> 
                    </div>
                          
                  </div>
              </div>
              <div class="mt-10">
                <button v-on:click="addBlog" type="submit" class="flex justify-center font-sans p-2 rounded-3xl text-xl w-60 h-12 bg-primary hover:bg-purple-900 text-white">Add Blog</button>
              </div>     
